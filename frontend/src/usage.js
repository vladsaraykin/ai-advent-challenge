...
export function summarizeUsage(messages, contextSummary, memory, workingMemory, invariants, lifecycle) {
  ...
  for (const usage of [memory?.archivedUsage, memory?.extractionUsage, workingMemory?.usage, invariants?.usage, lifecycle?.usage]) {
