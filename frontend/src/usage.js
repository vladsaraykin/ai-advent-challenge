...
export function summarizeUsage(messages, contextSummary, memory, workingMemory, invariants) {
  ...
  for (const usage of [memory?.archivedUsage, memory?.extractionUsage, workingMemory?.usage, invariants?.usage]) {
